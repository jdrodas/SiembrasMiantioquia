...
namespace Miantioquia.Formularios
{
    public partial class Principal : Form
    {
        ...
        {
            AbrirFormulario<SiembraReportes>();
        ...
        {
            AbrirFormulario<SiembraActualizada>();
        ...
        {
            AbrirFormulario<SiembraBorrada>();
